    ...
    <html lang="en" className="antialiased">
      <body className="min-h-screen flex flex-col">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
          <div className="absolute -top-[40%] -right-[20%] w-[800px] h-[800px] rounded-full bg-gradient-to-br from-primary-100/40 to-accent-100/20 blur-3xl" />
              ...
              <div className="px-6 h-16 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-3 group">
                  ...
                  <span className="text-xl font-bold tracking-tight text-stone-900">
                    Scholar<span className="text-primary-600">Map</span>
                  </span>
                </Link>
              ...
              <div className="grid md:grid-cols-4 gap-12">
                ...
                <div className="md:col-span-2">
                  <Link href="/" className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-xl font-bold tracking-tight">ScholarMap</span>
                  </Link>
                ...
                {/* Links */}
                <div>
                  <h4 className="font-semibold text-stone-900 mb-4 text-sm">Explore</h4>
                  <ul className="space-y-3">
                    <li><Link href="/programs" className="text-sm text-stone-500 hover:text-primary-600 transition-colors">All Programs</Link></li>
                    <li><Link href="/programs?level=bachelor" className="text-sm text-stone-500 hover:text-primary-600 transition-colors">Bachelor&apos;s</Link></li>
                    <li><Link href="/programs?level=masters" className="text-sm text-stone-500 hover:text-primary-600 transition-colors">Master&apos;s</Link></li>
                    <li><Link href="/programs?level=phd" className="text-sm text-stone-500 hover:text-primary-600 transition-colors">PhD</Link></li>
                  </ul>
                </div>

                <div>
                  <h4 className="font-semibold text-stone-900 mb-4 text-sm">Tools</h4>
                  <ul className="space-y-3">
                    <li><Link href="/qualify" className="text-sm text-stone-500 hover:text-primary-600 transition-colors">Eligibility Checker</Link></li>
                    <li><Link href="/admin" className="text-sm text-stone-500 hover:text-primary-600 transition-colors">Admin Portal</Link></li>
                  </ul>
                </div>
              </div>

              {/* Bottom */}
              <div className="mt-16 pt-8 border-t border-stone-200/60 flex flex-col md:flex-row items-center justify-between gap-4">
